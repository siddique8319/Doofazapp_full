                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              <label for="exampleFormControlInput1">Project Description</label>
                               <vue-editor v-model="form.projectDescription" name="projectDescription"></vue-editor> 
                            </div>                             
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              <label for="exampleFormControlInput1">Project Advantage</label>
                               <vue-editor v-model="form.projectAdvantage" name="projectAdvantage"></vue-editor> 
                            </div>                             
                          </div>
                        </div>          
                         <div class="row">
...
<script>
 ...
 import DatePicker from 'vue2-datepicker';
  import 'vue2-datepicker/index.css';
    ...
    methods: {
         editProject(){
            axios.get(`/project/${this.$route.params.id}/edit`).then(res =>{
                this.form.fill(res.data)
              })
         }, 
         updateProject(){
            axios.put(`/project/${this.$route.params.id}` ,this.form).then(res =>{
