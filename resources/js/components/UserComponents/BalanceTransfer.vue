              ...
              <div class="item col-xs-12 col-md-10" >
                <div class="panel panel-default">
                    <div class="panel-body">
                     <h3 class="text-h1 ribbon-heading ribbon-primary bottom-left-right">Balance Transfer</h3>   
                     <form @submit.prevent="add" >
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group"  >
                                <label for="exampleFormControlSelect1">select Receiver Id</label>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input  id="exampleFormControlInput1" placeholder="OTP"  v-model="form.shopCondition" type="text" name="shopCondition" :class="{ 'is-invalid': form.errors.has('shopCondition') }" class="form-control" >
                               <has-error :form="form" field="shopCondition"></has-error> 
                            </div>                             
                          </div>
                        </div>
