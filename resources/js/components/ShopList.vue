    ...
    <div class="row" data-toggle="isotope">
              <div class="item col-xs-12 col-md-10 " >                
                <div class="panel panel-default">
                    ...
                    <h3 class="text-h1 ribbon-heading ribbon-primary bottom-left-right">Shop List</h3>         
                        ...
                        <table data-toggle="" class="table table-responsive" cellspacing="1" width="200%">
                          ...
                          <tbody>
                            <tr v-for="(shop, index ) in shops" :key="shop.id" >
                               ...
                               <td v-if="shop.status==0"><span class="btn btn-danger" @click.prevent="approve(shop.shopId)">pending</span></td>
                               <td v-else>
...
<script>
    ...
    methods: {
        ...
        shop(){
         ...
         approve(shopId){
                axios.get(`/newShopEntry/${shopId}`).then(res =>{
                this.shop();   
                Toast.fire({
                icon: 'success',
